 ...
 */
package com.github.hotstu.boring.util.handlers;

import java.sql.ResultSet;
import java.sql.SQLException;

import com.github.hotstu.boring.util.RowProcessor;
 ...
 * @see com.github.hotstu.boring.util.ResultSetHandler
 * @since DbUtils 1.5
 */
public class BeanMapHandler<K, V> extends AbstractKeyedHandler<K, V> {
     ...
     *
     * @see com.github.hotstu.boring.util.handlers.AbstractKeyedHandler#createKey(ResultSet)
     */
