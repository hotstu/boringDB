 ...
 */
package com.github.hotstu.boring.util;
...
public class BasicRowProcessor implements RowProcessor {
     ...
     *
     * @see com.github.hotstu.boring.util.RowProcessor#toArray(ResultSet)
     ...
     * @see com.github.hotstu.boring.util.RowProcessor#toBean(ResultSet, Class)
     * @see com.github.hotstu.boring.util.BeanProcessor#toBean(ResultSet, Class)
     ...
     * @see com.github.hotstu.boring.util.RowProcessor#toBeanList(ResultSet, Class)
     * @see com.github.hotstu.boring.util.BeanProcessor#toBeanList(ResultSet, Class)
     * @param <T> The type of bean to create
     * @param rs ResultSet that supplies the bean data
     * @param type Class from which to create the bean instance
     * @throws SQLException if a database access error occurs
     ...
     * @throws SQLException if a database access error occurs
     * @see com.github.hotstu.boring.util.RowProcessor#toMap(ResultSet)
     */
    @Override
