...
import com.github.hotstu.boring.util.handlers.BeanHandler
import com.github.hotstu.boring.util.handlers.BeanListHandler
...
interface BaseDateBase {

}

class DatabaseBuilder<T : BaseDateBase>(private val clazz: Class<T>) {
...
class DaoBuilder<T : @Dao Any>(private val clazz: Class<T>) {
    ...
    private fun performInsert(entity: Any?): Boolean {
        return mSession!!.exec(0, entity!!)
    }

    private fun performDelete(entity: Any?): Boolean {
        return mSession!!.exec(1, entity!!)
    }

    private fun performUpdate(entity: Any?): Boolean {
        return mSession!!.exec(2, entity!!)
    }
}
